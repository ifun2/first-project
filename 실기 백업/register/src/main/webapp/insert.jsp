...
<form method="post" action="action.jsp" name="frm" style="display: flex; align-times: center; justify-content: center">
...
<tr>
  <td>학점</td>
  <td><input type="text" name="credit" style="width: 97%"></td>
</tr> 
<tr>
  <td>담당강사</td>
  <td>
...
<tr>
  <td>시작시간</td>
  <td><input type="text" name="start_hour" style="width: 97%"></td>
</tr> 
<tr>
  <td>종료시간</td>
  <td><input type="text" name="end_hour" style="width: 97%"></td>
</tr> 
<tr>
  <td colspan="2">
