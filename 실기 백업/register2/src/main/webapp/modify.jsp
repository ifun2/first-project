...
<h1 style="text-align: center "> <b>교과목 수정</b> </h1>

<form method="post" action="action.jsp" name="frm2" style= "display: flex; align-items: center; justify-content: center; text-align: center ">
...
<tr>
    <td>과목 코드</td>
    <td><input type="text" name="id" style= "width: 97%" value="<%=id %>" readonly> </td>
</tr>
<tr>
    <td>과목명</td>
    <td><input type="text" name="name" style= "width: 97%" value="<%=rs.getString(2) %>"> </td>
</tr>
<tr>
    <td>학점</td>
    <td><input type="text" name="credit" style= "width: 97%" value="<%=rs.getString(3) %>"> </td>
</tr>
<tr>
    <td>담당 강사</td>
    <td>
...
<tr>
      <td>시작시간</td>
      <td><input type="text" name="start_hour" style="width: 97%" value="<%=start_hour %>"></td>
</tr>  
<tr>
      <td>종료시간</td>
      <td><input type="text" name="end_hour" style="width: 97%" value="<%=end_hour %>"></td>
</tr>  
<tr>
      <td colspan="2">
