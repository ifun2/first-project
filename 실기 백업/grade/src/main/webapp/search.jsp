...
try { String sql = "SELETE st.stuid, sname, dept_name, subname, midscore, finalscore, attend, report, etc, " + 
                   "TO_CHAR(midscore*0.3 + final*0.3 + attend*0.2 + report*0.1 + etc*0.1, '999.0'), " + 
                   "midscore*0.3 + final*0.3 + attend*0.2 + report*0.1 + etc*0.1 " + 
